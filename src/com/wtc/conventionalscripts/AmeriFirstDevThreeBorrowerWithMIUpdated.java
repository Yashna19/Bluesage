...
public class AmeriFirstDevThreeBorrowerWithMIUpdated  extends BaseClass{
	...
	public static void setErrorCount(int errorCount) {
		AmeriFirstDevThreeBorrowerWithMIUpdated.errorCount = errorCount;
	}
	...
	public static void setScript_id(String script_id) {
		AmeriFirstDevThreeBorrowerWithMIUpdated.script_id = script_id;
	}
	...
	public static void setFilePath(String filePath) {
		AmeriFirstDevThreeBorrowerWithMIUpdated.filePath = filePath;
	}
	...
	public void getTestCountFromExcel(ITestContext context) throws InterruptedException, IOException, InvalidFormatException {
		...
		metaDataFile = "AmeriFirstDev3bWithMIUpdatedMetaData";
		dataFile = "AmeriFirstDev3bWithMIUpdated";
