...
public class AmeriFirstQuotesScript extends BaseClass {
	...
	public static void setErrorCount(int errorCount) {
		AmeriFirstQuotesScript.errorCount = errorCount;
	}
	...
	public static void setScript_id(String script_id) {
		AmeriFirstQuotesScript.script_id = script_id;
	}
	...
	public static void setFilePath(String filePath) {
		AmeriFirstQuotesScript.filePath = filePath;
	}
	...
	public void testCRMAndLOS() throws FileNotFoundException, InvalidFormatException, InterruptedException, IOException {
		extentTest  = extentReports.createTest("Test " + currentTestNo);
		//		 extentReports.createTest("01", extentReportsDescription).
		startPoint = "";
		endPoint = "";
		String s[][] = getExcelValues(CredentialsFile);
		String CrmURL = s[0][1];
