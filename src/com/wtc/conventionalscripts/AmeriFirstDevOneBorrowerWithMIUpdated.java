...
public class AmeriFirstDevOneBorrowerWithMIUpdated  extends BaseClass{
	...
	public static void setErrorCount(int errorCount) {
		AmeriFirstDevOneBorrowerWithMIUpdated.errorCount = errorCount;
	}
	...
	public static void setScript_id(String script_id) {
		AmeriFirstDevOneBorrowerWithMIUpdated.script_id = script_id;
	}
	...
	public static void setFilePath(String filePath) {
		AmeriFirstDevOneBorrowerWithMIUpdated.filePath = filePath;
	}
	...
	public void getTestCountFromExcel(ITestContext context) throws InterruptedException, IOException, InvalidFormatException {
		...
		metaDataFile = "AmeriFirstDev1bWithMIUpdatedMetaData";
		dataFile = "AmeriFirstDev1bWithMIUpdated";
